...
class Board:
    ...
    def has_ended(self):
        ...
        for idx in range(self._board_size):
            ...
            if (not tile.is_visited() and tile.get_colour() == Colour.RED and
        ...
        for idx in range(self._board_size):
            ...
            if (not tile.is_visited() and tile.get_colour() == Colour.BLUE and
                    self._winner is None):
    ...
    def DFS_colour(self, x, y, colour):
        ...
        for idx in range(Tile.NEIGHBOUR_COUNT):
            ...
            if (x_n >= 0 and x_n < self._board_size and y_n >= 0 and
                    y_n < self._board_size):
